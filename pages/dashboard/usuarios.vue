...
import { filterBoxs, initValues, initErrors, form } from '~/constants/usersPage';
...
const {
    ...
    generatePDF,
    filterInput
} = await usePage('/users', initValues, initErrors, ['Nombre', 'Apellido', 'Username', 'Role', 'Email'])
...
<template>
    <NuxtLayout name="dashboard">
        <div v-if="data.isPending !== true" class="flex flex-col p-4 w-full h-full">
            <SectionTitle id="titlePage" title="Usuarios" />
            <Controls />
            <Table />
            <PaginationMobile />
        </div>
                ...
                <div class="relative flex flex-col">
                    ...
                    <div class="px-8 flex flex-col">
                        ...
                        <InputDashboard v-model:errors="formErrors" v-model:value="formValues" id="confirPassword"
                            ...
                            help-message="Este campo debe de tener al menos 8 caracteres" />
