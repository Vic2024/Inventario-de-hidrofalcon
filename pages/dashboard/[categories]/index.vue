...
import { filterBoxs, initValues, initErrors, form } from '~/constants/recordPage';
...
definePageMeta({
    middleware: ['is-login', 'is-correct-equipment']
})
useHead(() => ({
    title: titlePage,
}));
const {
    ...
    generatePDF,
    filterInput
} = await usePage(`/api/${route.params.categories}`, initValues, initErrors, ['Marca', 'Modelo', 'Cantidad', 'creacion', 'Creado por', 'Modificacion', 'Modificado por'])
        ...
        <ClientOnly>
            <ModalDashboard :resetForm="resetForm" id='modal'>
                <div class="relative flex flex-col">
                    ...
                    <SubTitle id="editSub" :title="titlePage" />
